...
function navItems(){
  ...
  if(r==='pharmacist')return[{s:'Main'},{v:'dashboard',ic:'dash',lbl:'Dashboard'},{v:'pharma-mgmt',ic:'phar',lbl:'Prescription Queue',bdg:()=>PRESCRIPTIONS.filter(p=>p.status==='pending'||p.status==='processing').length||''},{v:'prescriptions',ic:'bill',lbl:'All Prescriptions'},{s:'Inventory'},{v:'Medicine-inventory',ic:'pkg',lbl:'Medicine Inventory'},{s:'Account'},{v:'profile',ic:'user',lbl:'Profile'}];

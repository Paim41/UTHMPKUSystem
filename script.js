...
// CORE DATA & STATE
// =============================================
const PASS_DB={'A21EB0001':'pass123','AI250201':'pass123','A20ME0112':'pass123','STF2047':'pass123','A21EE0078':'pass123','A20IT0221':'pass123','A21BM0055':'pass123','A20CE0308':'pass123','DOC001':'pass123','DOC002':'pass123','DEN001':'pass123','DEN002':'pass123','PHA001':'pass123','ADM001':'pass123'};
const ROLE_DB={'A21EB0001':'user','AI250201':'user','A20ME0112':'user','STF2047':'user','A21EE0078':'user','A20IT0221':'user','A21BM0055':'user','A20CE0308':'user','DOC001':'doctor','DOC002':'doctor','DEN001':'dentist','DEN002':'dentist','PHA001':'pharmacist','ADM001':'admin'};
const USERS_DB={
'AI250201':{name:'Muhammad Fahim bin Zainuddin',id:'AI250201',role:'user',subRole:'Student',faculty:'Faculty of Computer Science & IT',year:'Year 3',ic:'991231-14-1234',blood:'B+',allergy:'Penicillin',phone:'+60 12-345 6789',email:'ai250201@siswa.uthm.edu.my',approved:true},
...
let SYS={maxQ:150,resetT:'08:00',alertThr:20,smsNotif:true,emailNotif:true,pushNotif:true,apptLead:24,maxCancel:3,slotDur:30,autoConflict:true,reminder:true,rxAlert:true,payConfirm:true,consultFee:5.00,dentalFee:5.00,grace:7,duitnow:true,smap:true};
...
function toggleSb(){
  ...
  if(window.innerWidth<=640){
    ...
    // overlay shows behind sidebar (sidebar z-index 450 > overlay 400)
    document.getElementById('overlay').classList.toggle('on',op);
    document.body.style.overflow=op?'hidden':'';
    // ensure sidebar is fully interactive
    sb.style.pointerEvents=op?'all':'';
  }else{
    S.sbOpen=!S.sbOpen;
...
function vMedHistory(){
  ...
  document.getElementById('vc').innerHTML=
    ...
    +'<div><div style="font-weight:700;font-size:.97rem;color:var(--g900);line-height:1.3">'+u.name+'</div><div style="font-size:.78rem;color:var(--g500);margin-top:.15rem">'+u.id+' | '+capRole(u.subRole||u.role)+'</div>'
    +'<div class="prof-tags">'

...
function markAllRead(){NOTIFS.forEach(n=>n.read=true);buildNP();updateNdot();const el=document.getElementById('notifPgList');if(el)el.innerHTML=renderNotifCards(NOTIFS);toast('All marked as read','s');}
